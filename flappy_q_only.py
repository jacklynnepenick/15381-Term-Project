...
# Equivalent to flappy_combined except that no reproduction takes place thanks to the config file
config = config.Config(
        neat.DefaultGenome, neat.DefaultReproduction,
        neat.DefaultSpeciesSet, neat.DefaultStagnation,
        'flappy_config_q_only'
    )
...
class Bird:
    ...
    def backpropagate(self, value):
        expected_outputses = [
            ...
            for action in self.experiences["actions"]
        ]
